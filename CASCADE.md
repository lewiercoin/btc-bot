...
If `CASCADE.md` conflicts with `AGENTS.md` on workflow, role assignment, or authority chain, follow `AGENTS.md`.
...
4. Claude Code generates handoff → user pastes into Cascade
...
- Updated by builder after Claude Code decision
